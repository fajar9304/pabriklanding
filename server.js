...
* Aset Gambar Fitur: ${brief.featureImages || 'Gunakan placeholder standar.'} (Tampilkan sebagai: ${brief.featureSlider ? 'Slider' : 'Grid'})
* Aset Gambar Testimoni: ${brief.testimonialImages || 'Gunakan placeholder standar.'}
 ...
 * Menerima 'currentCode' dan 'editInstruction'.
 */
